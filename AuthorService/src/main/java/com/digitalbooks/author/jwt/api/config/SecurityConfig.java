...
//    }
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests().antMatchers("/author/login", "/author/register","/author/publishbook", "/author/getallbooksforauthor","/author/editorblockbook").permitAll()
